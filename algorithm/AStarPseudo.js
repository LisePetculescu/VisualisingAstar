...
function reconstructPathFromStartToGoal(cameFrom, currentNode) {
  // create list to add nodes from cheapest path starting at goal moving towards start
  // could also use linkedlist for pathList
  // add currentNode to list
  let pathList = [currentNode];

  // predesessorsList is a map of nodes that are the predessesor of the current nodes
  // making a loop to add all nodes in camFrom to the path list
